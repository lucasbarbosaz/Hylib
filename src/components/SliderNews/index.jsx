...
const SliderNews = ({ news, key }) => {
    ...
    return (
        <>
            ...
            <Link to={`/news/${news[currentNewsIndex]?.id}?liked=true`} className="last-articles-slide pd-4 no-link show" style={{ backgroundImage: `url(${news[currentNewsIndex]?.image})` }} key={news[currentNewsIndex]}>
