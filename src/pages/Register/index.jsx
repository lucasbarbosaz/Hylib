...
const Register = () => {
  ...
  const sendAlert = (type, severity, message) => {
    if (type === "username") {
      setAlertUsername(
        severity === null || message === null ? null : <Check type={severity} message={message} />
      );
    } else if (type === "email") {
      setAlertEmail(
        severity === null || message === null ? null : <Check type={severity} message={message} />
  ...
  const sendRegisterFormAlert = (severity, message) => {
    setRegisterAlert(severity === null || message === null ? null : <Alert message={message} />);
  };
  ...
  return (
    <>
      <Head alert={registerAlert} use={false} />
      <Header />
      <div className="webcenter flex-column">
        <div className="flex">
            ...
            <div className="general-box register-area margin-top-md height-auto">
              ...
              <form onSubmit={handleSubmitNewUser} className="padding-minm padding-top-none register-form">
                <div className="flex-column margin-bottom-min">
                  <label className="font-theme margin-bottom-minm">
                    <h6>
                      {i18n.t("register.usernameInput.details")}
                      <br />
                      <br />
                      {i18n.t("register.usernameInput.requirements")}
                    </h6>
                  </label>
                  <div className="register-inputs width-content flex">
                    ...
                    <input
                      type="text"
                      name="username"
                      placeholder={i18n.t("register.usernameInput.placeholder")}
                      data-input="username"
                      id="username"
                      value={newUser.username}
                      onKeyUp={(e) => onKeyUpInputs("username", e.target.value)}
                      onChange={(e) => updateNewUser("username", e.target.value)}
                    />
                    <div className="reg-status username pointer-none">{alertUsername}</div>
                  </div>
                </div>
                ...
                <div className="flex-column margin-bottom-min">
                  ...
                  <div className="register-inputs width-content flex">
                    ...
                    <input
                      type="email"
                      name="email"
                      placeholder={i18n.t("register.emailInput.placeholder")}
                      data-input="email"
                      id="email"
                      value={newUser.email}
                      onKeyUp={(e) => onKeyUpInputs("email", e.target.value)}
                      onChange={(e) => updateNewUser("email", e.target.value)}
                    />
                    <div className="reg-status email pointer-none">{alertEmail}</div>
                  </div>
                </div>
                ...
                <div className="flex-column margin-bottom-min">
                  ...
                  <div className="register-inputs width-content flex">
                    ...
                    <input
                      type="password"
                      name="password"
                      placeholder={i18n.t("register.passwordInput.placeholder")}
                      data-input="password"
                      value={newUser.password}
                      onKeyUp={(e) => onKeyUpInputs("password", e.target.value)}
                      onChange={(e) => updateNewUser("password", e.target.value)}
                    />
                    <div className="reg-status password pointer-none">{alertPassword}</div>
                  </div>
                </div>
                <label className="font-theme">
                  ...
                  <div className="flex width-content">
                    <div className="margin-right-minm flex reg-gender">
                      <input
                        ...
                        onClick={(e) => updateNewUser("gender", e.target.value)}
                        defaultChecked
                      />
                  ...
                  <div className="flex-column col-6 margin-left-min">
                    <div className="result-register-card flex">
                      ...
                      <label className="white flex-column text-nowrap">
                        <h4 className="bold text-nowrap">
                          {newUser.username !== null && newUser.username !== ""
                            ? newUser.username
                            : i18n.t("register.registerPreview.title")}
                        </h4>
                        <h6 className="margin-auto-top margin-bottom-minm text-nowrap">
                          {i18n.t("register.registerPreview.smallText")}
                        </h6>
                      </label>
                    </div>
          ...
          <div
            className={`font-theme flex-column margin-left-max margin-top-max col-5${
              isMobile ? " display-none" : ""
            }`}
          >
            <label className="flex-column">
              <h2 className="bold margin-bottom-min">
                {i18n.t("register.aboutHotel.title")} {config.hotel.name}
              </h2>
              <div className="flex margin-auto-bottom">
                <h5 className="fs-14">
                  <b>{config.hotel.name}</b> {i18n.t("register.aboutHotel.firstDescription")}
                </h5>
                <img
                  className="margin-auto-top-bottom"
                  style={{ minWidth: "200px", height: "123px" }}
                  src="https://images.habbo.com/c_images/WhatIsHabbo/ill_17.png"
                />
              </div>
              <div className="flex margin-top-md">
                <img
                  className="margin-auto-top-bottom"
                  style={{ minWidth: "200px", height: "171px" }}
                  src="https://images.habbo.com/c_images/WhatIsHabbo/ill_16.png"
                />
              ...
              <div className="flex margin-auto-top">
                ...
                <img
                  className="margin-auto-top-bottom"
                  style={{ minWidth: "198px", height: "157px" }}
                  src={comment}
                />
              </div>
            </label>
